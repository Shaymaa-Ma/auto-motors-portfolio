...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 14, 2026 at 11:23 AM
...
(1, 'La qualité au service de nos clients', 'Quality at the Service of Our Customers', 'Notre engagement pour des produits fiables et un service professionnel', 'Our commitment to reliable products and professional service', 'Produits de qualité', 'Quality Products', 'Nous proposons des produits de qualité pour répondre aux besoins de nos clients.', 'We provide quality products to meet our customers’ needs.', 'bi-award', 1, 1, '2026-09-05 07:20:28', '2026-09-10 17:39:15'),
(2, 'La qualité au service de nos clients', 'Quality at the Service of Our Customers', 'Notre engagement pour des produits fiables et un service professionnel', 'Our commitment to reliable products and professional service', 'Prix compétitifs', 'Competitive Prices', 'Des prix compétitifs pour les particuliers et les professionnels.', 'Competitive prices for individuals and professionals.', 'bi-tags', 2, 1, '2026-09-05 07:20:28', '2026-09-10 10:05:21'),
(3, 'La qualité au service de nos clients', 'Quality at the Service of Our Customers', 'Notre engagement pour des produits fiables et un service professionnel', 'Our commitment to reliable products and professional service', 'Importation fiable', 'Reliable Importation', 'Une activité d’importation dédiée aux produits et équipements automobiles.', 'Reliable importation of automotive products and equipment.', 'bi-box-seam', 3, 1, '2026-09-05 07:20:28', '2026-09-10 10:05:21'),
(4, 'La qualité au service de nos clients', 'Quality at the Service of Our Customers', 'Notre engagement pour des produits fiables et un service professionnel', 'Our commitment to reliable products and professional service', 'Large gamme de produits', 'Wide Range of Products', 'Une gamme comprenant batteries, pneus, lubrifiants et pièces détachées.', 'A range including batteries, tires, lubricants and spare parts.', 'bi-grid-3x3-gap', 4, 1, '2026-09-05 07:20:28', '2026-09-10 10:05:21'),
(5, 'La qualité au service de nos clients', 'Quality at the Service of Our Customers', 'Notre engagement pour des produits fiables et un service professionnel', 'Our commitment to reliable products and professional service', 'Distribution partout en Côte d’Ivoire', 'Distribution Throughout Côte d’Ivoire', 'Distribution de nos produits dans différentes régions de la Côte d’Ivoire.', 'Distribution of our products across different regions of Côte d’Ivoire.', 'bi-truck', 5, 1, '2026-09-05 07:20:28', '2026-09-10 10:05:21');
...
CREATE TABLE IF NOT EXISTS `company_info` (
  ...
  `tagline_fr` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tagline_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address_fr` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `address_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone_1` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone_2` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone_3` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `contact` (
  ...
  `subtitle_fr` text COLLATE utf8mb4_unicode_ci,
  `subtitle_en` text COLLATE utf8mb4_unicode_ci,
  `intro_title_fr` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `intro_title_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `intro_description_fr` text COLLATE utf8mb4_unicode_ci,
  `intro_description_en` text COLLATE utf8mb4_unicode_ci,
  `call_button_fr` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `call_button_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `info_title_fr` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `info_title_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `info_description_fr` text COLLATE utf8mb4_unicode_ci,
  `info_description_en` text COLLATE utf8mb4_unicode_ci,
  `phone_label_fr` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone_label_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_label_fr` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_label_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address_label_fr` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address_label_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `delivery_available` tinyint(1) NOT NULL DEFAULT '1',
  `delivery_title_fr` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `delivery_title_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `delivery_description_fr` text COLLATE utf8mb4_unicode_ci,
  `delivery_description_en` text COLLATE utf8mb4_unicode_ci,
  `follow_title_fr` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `follow_title_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `contact` (`id`, `title_fr`, `title_en`, `subtitle_fr`, `subtitle_en`, `intro_title_fr`, `intro_title_en`, `intro_description_fr`, `intro_description_en`, `call_button_fr`, `call_button_en`, `info_title_fr`, `info_title_en`, `info_description_fr`, `info_description_en`, `phone_label_fr`, `phone_label_en`, `email_label_fr`, `email_label_en`, `address_label_fr`, `address_label_en`, `delivery_available`, `delivery_title_fr`, `delivery_title_en`, `delivery_description_fr`, `delivery_description_en`, `follow_title_fr`, `follow_title_en`, `created_at`, `updated_at`) VALUES
(1, 'Contactez-nous', 'Contact Us', 'Notre équipe est à votre disposition pour répondre à vos besoins.', 'Our team is available to help with your automotive needs.', 'Parlons de vos besoins', 'Let\'s discuss your needs', 'Contactez-nous pour connaître la disponibilité de nos produits et discuter de vos besoins.', 'Contact us to check product availability and discuss your needs.', 'Nous appeler', 'Call us', 'Besoin d\'informations ?', 'Need more information?', 'Contactez-nous directement pour connaître la disponibilité de nos produits et obtenir plus d\'informations.', 'Contact us directly to check product availability and get more information.', 'Téléphone', 'Phone', 'Email', 'Email', 'Adresse', 'Address', 1, 'Distribution disponible', 'Delivery available', 'Nous assurons la distribution selon les besoins de nos clients.', 'We provide distribution according to our clients\' needs.', 'Suivez-nous', 'Follow Us', '2026-09-14 08:29:05', '2026-09-14 09:12:21');
...
(1, 1, 'Batterie automobile 12V', '12V Automotive Battery', 'Batterie destinée aux véhicules automobiles.', 'Battery designed for automotive vehicles.', '70 $', 'products/battery-001.jpg', '001', 1, 1, '2026-09-05 07:20:28', '2026-09-10 08:06:54'),
...
(1, 'Des produits automobiles de qualité', 'Quality Automotive Products', 'Batteries, pneus, lubrifiants et pièces détachées', 'Batteries, tires, lubricants and spare parts', 'Batteries', 'Batteries', 'Batteries automobiles pour différents types de véhicules.', 'Automotive batteries for different types of vehicles.', 'categories/batteries.jpg', 1, 1, '2026-09-05 07:20:28', '2026-09-10 09:41:20'),
(2, 'Des produits automobiles de qualité', 'Quality Automotive Products', 'Batteries, pneus, lubrifiants et pièces détachées', 'Batteries, tires, lubricants and spare parts', 'Pneus', 'Tires', 'Pneus adaptés aux voitures, camionnettes et véhicules lourds.', 'Tires suitable for cars, light trucks and heavy-duty vehicles.', 'categories/tires.jpg', 2, 1, '2026-09-05 07:20:28', '2026-09-10 09:41:20'),
(3, 'Des produits automobiles de qualité', 'Quality Automotive Products', 'Batteries, pneus, lubrifiants et pièces détachées', 'Batteries, tires, lubricants and spare parts', 'Lubrifiants', 'Lubricants', 'Lubrifiants et huiles moteur pour différents types de véhicules.', 'Lubricants and motor oils for different types of vehicles.', 'categories/lubricants.jpg', 3, 1, '2026-09-05 07:20:28', '2026-09-10 09:41:20'),
(4, 'Des produits automobiles de qualité', 'Quality Automotive Products', 'Batteries, pneus, lubrifiants et pièces détachées', 'Batteries, tires, lubricants and spare parts', 'Pièces détachées', 'Spare Parts', 'Pièces et composants automobiles pour différents besoins.', 'Automotive parts and components for different needs.', 'categories/spare-parts.jpg', 4, 1, '2026-09-05 07:20:28', '2026-09-10 09:41:20');
...
(30, 'admin_registration_open', '1', '2026-09-14 07:28:54', '2026-09-14 07:28:54');
...
(1, 'Suivez-nous', 'Follow Us', 'Restez connectés avec AUTO MOTORS SARL', 'Stay connected with AUTO MOTORS SARL', 'Facebook', 'https://facebook.com/auto-motors-demo', 'bi-facebook', 1, 1, '2026-09-05 07:20:28', '2026-09-10 10:12:03'),
(2, 'Suivez-nous', 'Follow Us', 'Restez connectés avec AUTO MOTORS SARL', 'Stay connected with AUTO MOTORS SARL', 'Instagram', 'https://instagram.com/auto_motors_demo', 'bi-instagram', 2, 1, '2026-09-05 07:20:28', '2026-09-10 10:12:03'),
(3, 'Suivez-nous', 'Follow Us', 'Restez connectés avec AUTO MOTORS SARL', 'Stay connected with AUTO MOTORS SARL', 'WhatsApp', 'https://wa.me/2250749616161', 'bi-whatsapp', 3, 1, '2026-09-05 07:20:28', '2026-09-10 10:12:03'),
(4, 'Suivez-nous', 'Follow Us', 'Restez connectés avec AUTO MOTORS SARL', 'Stay connected with AUTO MOTORS SARL', 'LinkedIn', 'https://linkedin.com/company/auto-motors-demo', 'bi-linkedin', 4, 1, '2026-09-05 07:20:28', '2026-09-10 10:12:03');
