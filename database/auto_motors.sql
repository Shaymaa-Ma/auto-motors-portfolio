...
CREATE TABLE IF NOT EXISTS `advantages` (
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_advantages_active_order` (`is_active`,`display_order`,`id`)
...
(1, 'La qualité au service de nos clients', 'Quality at the Service of Our Customers', 'Notre engagement pour des produits fiables et un service professionnel', 'Our commitment to reliable products and professional service', 'Produits de qualité', 'Quality Products', 'Nous proposons des produits de qualité pour répondre aux besoins de nos clients.', 'We provide quality products to meet our customers’ needs.', 'bi-award', 1, 1, '2026-09-05 07:20:28', '2026-09-22 17:13:14'),
(2, 'La qualité au service de nos clients', 'Quality at the Service of Our Customers', 'Notre engagement pour des produits fiables et un service professionnel', 'Our commitment to reliable products and professional service', 'Prix compétitifs', 'Competitive Prices', 'Des prix compétitifs pour les particuliers et les professionnels.', 'Competitive prices for individuals and professionals.', 'bi-tags', 2, 1, '2026-09-05 07:20:28', '2026-09-22 17:13:14'),
(3, 'La qualité au service de nos clients', 'Quality at the Service of Our Customers', 'Notre engagement pour des produits fiables et un service professionnel', 'Our commitment to reliable products and professional service', 'Importation fiable', 'Reliable Importation', 'Une activité d’importation dédiée aux produits et équipements automobiles.', 'Reliable importation of automotive products and equipment.', 'bi-box-seam', 3, 1, '2026-09-05 07:20:28', '2026-09-22 17:13:14'),
(4, 'La qualité au service de nos clients', 'Quality at the Service of Our Customers', 'Notre engagement pour des produits fiables et un service professionnel', 'Our commitment to reliable products and professional service', 'Large gamme de produits', 'Wide Range of Products', 'Une gamme comprenant batteries, pneus, lubrifiants et pièces détachées.', 'A range including batteries, tires, lubricants and spare parts.', 'bi-grid-3x3-gap', 4, 1, '2026-09-05 07:20:28', '2026-09-22 17:13:14'),
(5, 'La qualité au service de nos clients', 'Quality at the Service of Our Customers', 'Notre engagement pour des produits fiables et un service professionnel', 'Our commitment to reliable products and professional service', 'Distribution partout en Côte d’Ivoire', 'Distribution Throughout Côte d’Ivoire', 'Distribution de nos produits dans différentes régions de la Côte d’Ivoire.', 'Distribution of our products across different regions of Côte d’Ivoire.', 'bi-truck', 5, 1, '2026-09-05 07:20:28', '2026-09-22 17:13:14');
...
CREATE TABLE IF NOT EXISTS `gallery` (
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_gallery_active_order` (`is_active`,`display_order`,`id`)
...
CREATE TABLE IF NOT EXISTS `services` (
  ...
  KEY `idx_services_order_id` (`display_order`,`id`),
...
(5, 'Des solutions automobiles adaptées à vos besoins', 'Automotive Solutions Tailored to Your Needs', 'Une gamme de services pour les particuliers et les professionnels', 'A range of services for individuals and professionals', 'Vente en gros', 'Wholesale', 'Fourniture de produits automobiles aux magasins, revendeurs et professionnels.', 'Supply of automotive products to stores, resellers and professionals.', 'bi-box-seam', 5, 1, '2026-09-05 07:20:28', '2026-09-22 16:35:22'),
(6, 'Des solutions automobiles adaptées à vos besoins', 'Automotive Solutions Tailored to Your Needs', 'Une gamme de services pour les particuliers et les professionnels', 'A range of services for individuals and professionals', 'Distribution en Côte d’Ivoire', 'Distribution in Côte d’Ivoire', 'Distribution de nos produits dans différentes régions de la Côte d’Ivoire.', 'Distribution of our products across different regions of Côte d’Ivoire.', 'bi-truck', 6, 1, '2026-09-05 07:20:28', '2026-09-22 16:35:22');
...
(1, 'Suivez-nous', 'Follow Us', 'Restez connectés avec AUTO MOTORS SARL', 'Stay connected with AUTO MOTORS SARL', 'Facebook', 'https://facebook.com/auto-motors-demo', 'bi-facebook', 1, 1, '2026-09-05 07:20:28', '2026-09-22 19:08:54'),
(2, 'Suivez-nous', 'Follow Us', 'Restez connectés avec AUTO MOTORS SARL', 'Stay connected with AUTO MOTORS SARL', 'Instagram', 'https://instagram.com/auto_motors_demo', 'bi-instagram', 2, 1, '2026-09-05 07:20:28', '2026-09-22 19:08:54'),
(3, 'Suivez-nous', 'Follow Us', 'Restez connectés avec AUTO MOTORS SARL', 'Stay connected with AUTO MOTORS SARL', 'WhatsApp', 'https://wa.me/2250749616161', 'bi-whatsapp', 3, 1, '2026-09-05 07:20:28', '2026-09-22 19:07:23'),
(4, 'Suivez-nous', 'Follow Us', 'Restez connectés avec AUTO MOTORS SARL', 'Stay connected with AUTO MOTORS SARL', 'LinkedIn', 'https://linkedin.com/company/auto-motors-demo', 'bi-linkedin', 4, 1, '2026-09-05 07:20:28', '2026-09-22 19:07:23');
